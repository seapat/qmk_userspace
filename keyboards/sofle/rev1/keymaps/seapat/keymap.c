...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAME_BASE] = LAYOUT(
        ...
        KC_G,     KC_LSFT,  KC_A,    KC_S,    KC_D,                   KC_F,                                               KC_H,               KC_J,    KC_K,             KC_L,   KC_SEMICOLON, KC_QUOTE,
        KC_TAB,   KC_B,     KC_Z,    KC_X,    KC_C,                   KC_V,              KC_MUTE,  KC_MPLY,               KC_N,               KC_M,    KC_COMM,          KC_DOT, KC_SLSH,      KC_RSFT,
                            KC_LALT, KC_LGUI, LT(_GAME_SWAP, KC_DEL), KC_LCTL, KC_SPC,   LT(_QWERTY, KC_ENTER), LT(_SYMB, KC_BSPC), KC_RALT, LT(_EXT, KC_LBRC), KC_RBRC
    ),
